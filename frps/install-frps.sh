...
program_version_link="https://raw.githubusercontent.com/dadamimi/frp/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/dadamimi/frp/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
